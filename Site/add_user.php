...
---------------------------------------------------------------------------
Page 'add_user.php', formulaire d'ajout d'un nouveau utilisateur.
---------------------------------------------------------------------------
L'utilisateur :
Ne peut rien faire.
---------------------------------------------------------------------------
...
<meta charset="UTF-8">
   ...
   <body>
    ...
    <?php require_once('entete.php'); ?>
        <div id="contenu">
        	<div id="banniere">Ajout d'un utilisateur</div>
          		<div id="form-ajout">

          			<fieldset><legend>Ajout utilisateur</legend> <!-- Cadre -->
						...
						<form method="post" action="add.php">
							...
							<label id="ajout_element">Rôle : </label>
								<select name="role_user" > <!-- Liste déroulante -->
