...
CREATE TABLE IF NOT EXISTS `ecotron`.`Acronime_Etiquette` (
  ...
  `valeur_acronime` VARCHAR(45) NULL,
...
CREATE TABLE IF NOT EXISTS `ecotron`.`Categorie_Etiquette` (
  ...
  `valeur_categorie` VARCHAR(45) NULL,
  `idAcronimeEtiquette` INT NOT NULL,
  PRIMARY KEY (`idCategorieEtiquette`, `idAcronimeEtiquette`),
  INDEX `fk_Categorie_Etiquette_Acronime_Etiquette1_idx` (`idAcronimeEtiquette` ASC))
ENGINE = InnoDB;
...
CREATE TABLE IF NOT EXISTS `ecotron`.`Plateforme` (
  ...
  PRIMARY KEY (`idPlateforme`, `idLieu_Equipement`),
  INDEX `fk_Plateforme_Lieu_Equipement1_idx` (`idLieu_Equipement` ASC))
ENGINE = InnoDB;
